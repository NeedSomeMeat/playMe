...
var TrackModel = (function () {
    function TrackModel(album, artists, available_markets, disc_number, duration_ms, explicit, external_ids, external_urls, href, id, name, popularity, preview_url, track_number, uri, type) {
